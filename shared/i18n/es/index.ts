export const es = {
  ...
  'identity.paragraph1':
    'Como explorador en la intersección de tecnología e innovación, valoro la simplicidad en medio de la complejidad, priorizando soluciones intuitivas que respeten al usuario y generen resultados.',
  'identity.paragraph2':
    'Mi esencia se define por una curiosidad incesante que me impulsa a desafiar límites. Siempre guiado por el deseo de inspirar a otros a materializar conceptos audaces que transformen sus necesidades.',
  ...
  'purpose.paragraph1':
    'Creo en la tecnología como catalizador para ideas que generen impacto positivo a escala global. Mi enfoque radica en fusionar innovación técnica con diseño empático, creando soluciones que resuelvan problemas complejos de manera sostenible y accesible.',
  'purpose.paragraph2':
    'Me motiva el equilibrio entre funcionalidad y experiencia humana, anticipando necesidades futuras para construir un ecosistema digital que inspire cambio',
  ...
  'connection.subtitle':
    'Si tienes ideas, proyectos o simplemente quieres intercambiar perspectivas sobre tecnología y diseño, conectemos.',
  ...
  'matrix.message':
    'El modo Matrix es visualmente intensivo y puede afectar el rendimiento de tu dispositivo, especialmente en móviles y laptops.',
