...
import FloatingNavParticles from '../molecules/FloatingNavParticles';
...
export default function DesktopNav({
  ...
  return (
    ...
    >
      ...
      <NavLogo lowPerformanceMode={lowPerformanceMode} />

      <StatusIndicator lowPerformanceMode={lowPerformanceMode} />
      ...
      {/* Social Links */}
      <div className="flex flex-col relative z-10 gap-fluid-sm">
