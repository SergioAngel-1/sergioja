...
const translations = {
  es: {
    ...
    'terminal.helpProjects': 'Ver proyectos del portafolio',
    ...
    'alerts.incompleteFields': 'Campos incompletos',
    ...
    'validation.minLength': 'debe tener al menos',
    'validation.maxLength': 'no puede exceder',
    'validation.characters': 'caracteres',
  },
  en: {
    // Navbar
    'nav.home': 'HOME',
    ...
    'terminal.helpProjects': 'View portfolio projects',
    'terminal.projects': 'projects',
    'terminal.status': 'status',
    ...
    'alerts.incompleteFields': 'Incomplete fields',
    ...
    'validation.minLength': 'must be at least',
    'validation.maxLength': 'cannot exceed',
