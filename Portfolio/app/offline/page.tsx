        ...
        {isOnline ? (
          ...
          <>
            <motion.div
              ...
              className="w-20 h-20 mx-auto mb-6 rounded-full border-4 border-cyber-blue-cyan border-t-transparent"
            />
            ...
            <button
              ...
              className="px-6 py-3 bg-cyber-blue-cyan text-background-dark font-rajdhani font-bold rounded-lg hover:bg-white transition-colors"
            >
              Reintentar
            </button>
          </>
