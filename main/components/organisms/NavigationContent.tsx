  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: fluidSizing.space.md }}>
      ...
      <div style={{ paddingTop: fluidSizing.space.lg, marginTop: fluidSizing.space.md, borderTop: '1px solid rgba(255, 255, 255, 0.05)' }}>
        ...
        {/* Cookie preferences */}
        <div className="flex items-center justify-center" style={{ marginTop: fluidSizing.space.sm }}>
          <button
            onClick={() => {
              openPreferences();
              logger.info('Cookie preferences opened', 'NavigationContent');
            }}
            className="text-white/30 hover:text-white/60 transition-colors duration-200 text-fluid-xs font-mono flex items-center gap-1"
          >
