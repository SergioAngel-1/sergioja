      ...
      >
        {connections.map((connection, index) => (
          <a
            key={index}
            href="#"
            className="group flex items-center gap-3 p-3 rounded-lg border border-white/10 hover:border-white/30 hover:bg-white/5 transition-all duration-300"
          >
            <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors text-white">
              {connection.icon}
            </div>
            <div className="flex-1 min-w-0">
              <h4 className="text-white font-medium text-sm">{connection.platform}</h4>
              <p className="text-white/60 text-xs truncate">{connection.handle}</p>
            </div>
