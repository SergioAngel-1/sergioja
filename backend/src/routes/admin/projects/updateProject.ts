...
export const updateProject = asyncHandler(async (req: Request, res: Response) => {
    ...
    const project = await prisma.project.update({
      ...
      data: {
        ...
        imagesDesktop: imagesDesktop !== undefined ? (Array.isArray(imagesDesktop) ? imagesDesktop : []) : existingProject.imagesDesktop,
        imagesMobile: imagesMobile !== undefined ? (Array.isArray(imagesMobile) ? imagesMobile : []) : existingProject.imagesMobile,
